...
"[project]/node_modules/mqtt/dist/mqtt.esm.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var Mt, Qr, wr, Pi, lc, cc, fc, hc, dc, pc, yc, gc, bc, wc, mc, _c, vc, Sc, Ec, Ac, Ic, Tc, Pc, Oc, Bc, Mc, Ri, Nc, qc, Lc, Uc, Dc, jc, Wc, $c, Hc, Gc, zc, Kc, Qc, Yc, Jc, Xc, Zc, ef, tf, rf, nf, of, sf, af, uf, Jt, us, ls, cf, ff, hf, df, pf, yf, gf, bf, wf, mf, _f, Sf, Ef = ze(()=>{
    ...
    lc = "browser", cc = "x64", fc = "browser", hc = {
        ...
        "/usr/bin/node"
    ], pc = [], yc = "v16.8.0", gc = {}, bc = function(t, e) {
        console.warn((e ? e + ": " : "") + t);
    }, wc = function(t) {
        cs("binding");
    }, mc = function(t) {
...
function yw() {
    ...
    function f(T, y, O, v) {
        ...
        else if (typeof U == "function" ? U = F[y] = v ? [
            O,
            U
        ] : [
            U,
            O
        ] : v ? U.unshift(O) : U.push(O), M = c(T), M > 0 && U.length > M && !U.warned) {
            U.warned = !0;
    ...
    function m(T, y, O) {
        ...
        if (v === void 0) return [];
        var M = v[y];
        return M === void 0 ? [] : typeof M == "function" ? O ? [
            M.listener || M
        ] : [
            M
        ] : O ? b(M) : P(M, M.length);
...
var $e = j((OO, ys)=>{
    ...
    ys.exports = {
        ...
        AbortSignalAny: Pw.any || function(e) {
            ...
            return e.forEach((i)=>{
                Lf(i, "signals"), i.addEventListener("abort", n, {
                    once: !0
                });
...
var Nn = j((Jk, bd)=>{
    ...
    le.prototype.pipe = function(t, e) {
        ...
        n.pipes.length === 1 && (n.multiAwaitDrain || (n.multiAwaitDrain = !0, n.awaitDrainWriters = new J_(n.awaitDrainWriters ? [
            n.awaitDrainWriters
        ] : []))), n.pipes.push(t), de("pipe count=%d opts=%j", n.pipes.length, e);
        ...
        return {
            value: t(async function*() {
                for(;;){
                    ...
                    if (i.aborted) throw new Fd(void 0, {
                        cause: i.reason
                    });
    ...
    function tp(t, e, r) {
        ...
        for(let R = 0; R < t.length; R++){
            ...
            if (R === 0) if (typeof T == "function") {
                if (S = T({
                    signal: i
                }), !Pr(S)) throw new ua("Iterable, AsyncIterable or Stream", "source", S);
                ...
                if (io(S)) m++, ya(pa(S), T, g, {
                    end: v
                });
                else if (ca(S) || Pr(S)) m++, ya(S, T, g, {
                    end: v
                });
                else if (cn(S)) m++, ya(S.readable, T, g, {
                    end: v
                });
                else throw new ga("val", [
                    "Readable",
...
var Pa = j((QM, qp)=>{
    ...
    K.SESSIONPRESENT_HEADER = Ke.from([
        K.SESSIONPRESENT_MASK
    ]);
    K.CONNACK_HEADER = Ke.from([
        K.codes.connack << K.CMD_SHIFT
    ]);
    K.USERNAME_MASK = 128;
    K.PASSWORD_MASK = 64;
    ...
    K.CONNECT_HEADER = Ke.from([
        K.codes.connect << K.CMD_SHIFT
    ]);
    K.properties = {
    ...
    K.SUBACK_HEADER = Ke.from([
        K.codes.suback << K.CMD_SHIFT
    ]);
    K.VERSION3 = Ke.from([
        3
    ]);
    ...
    K.VERSION131 = Ke.from([
        131
    ]);
    K.VERSION132 = Ke.from([
        132
    ]);
    K.QOS = [
        0,
...
var jp = j((y2, Dp)=>{
    ...
    function DS(t) {
        ...
        function r(h) {
            ...
            function S(...b) {
                if (!S.enabled) return;
                let w = S, _ = Number(new Date), R = _ - (d || _);
    ...
    var GS = Bp(), { EventEmitter: zS } = (er(), me(Zt)), Fp = Np(), pe = Pa(), ae = At()("mqtt-packet:parser"), Oa = class t extends zS {
        ...
        _parseProperties() {
            ...
            for(; this._pos < n;){
                ...
                i[o] ? Array.isArray(i[o]) ? i[o].push(this._parseByType(pe.propertiesTypes[o])) : (i[o] = [
                    i[o]
                ], i[o].push(this._parseByType(pe.propertiesTypes[o]))) : i[o] = this._parseByType(pe.propertiesTypes[o]);
            }
            return i;
        }
        _newPacket() {
...
var zp = j((H2, Gp)=>{
    ...
    x();
    I();
    var { Buffer: Hn } = (ke(), me(qe)), KS = 65536, Hp = {}, QS = Hn.isBuffer(Hn.from([
        1,
        2
    ]).subarray(0, 1));
    function Vp(t) {
...
var Kp = j((eN, Ra)=>{
    ...
    x();
    I();
    typeof N > "u" || !N.version || N.version.indexOf("v0.") === 0 || N.version.indexOf("v1.") === 0 && N.version.indexOf("v1.8.") !== 0 ? Ra.exports = {
        nextTick: ZS
    } : Ra.exports = N;
    function ZS(t, e, r, n) {
...
var Ba = j((cN, ry)=>{
    ...
    var ue = Pa(), { Buffer: se } = (ke(), me(qe)), eE = se.allocUnsafe(0), tE = se.from([
        0
    ]), Vn = zp(), rE = Kp().nextTick, rt = At()("mqtt-packet:writeToStream"), yo = Vn.cache, nE = Vn.generateNumber, iE = Vn.generateCache, ka = Vn.genBufVariableByteInt, oE = Vn.generate4ByteBuffer, He = Ca, go = !0;
    function ey(t, e, r) {
    ...
    function aE(t, e, r) {
        ...
        if (g += i.length + 2, s !== 3 && s !== 4 && s !== 5) return e.destroy(new Error("Invalid protocol version")), !1;
        ...
        let w = 0;
        return w |= h != null ? ue.USERNAME_MASK : 0, w |= d != null ? ue.PASSWORD_MASK : 0, w |= o && o.retain ? ue.WILL_RETAIN_MASK : 0, w |= o && o.qos ? o.qos << ue.WILL_QOS_SHIFT : 0, w |= o ? ue.WILL_FLAG_MASK : 0, w |= a ? ue.CLEAN_SESSION_MASK : 0, e.write(se.from([
            w
        ])), He(e, c), s === 5 && P.write(), pn(e, f), o && (s === 5 && S.write(), Br(e, o.topic), pn(e, o.payload)), h != null && pn(e, h), d != null && pn(e, d), !0;
    }
    function uE(t, e, r) {
    ...
    function cE(t, e, r) {
        ...
        return e.write(ue.ACKS[s][c][a][0]), d === 3 && (d += f !== 0 ? 1 : -1), nt(e, d), He(e, o), n === 5 && d !== 2 && e.write(se.from([
            f
        ])), m !== null ? m.write() : d === 4 && e.write(se.from([
            0
        ])), !0;
    }
    function fE(t, e, r) {
        ...
        if (typeof a == "object" && a.length) for(let m = 0; m < a.length; m += 1){
            ...
            if (typeof g != "string") return e.destroy(new Error("Invalid subscriptions - invalid topic")), !1;
            if (typeof P != "number") return e.destroy(new Error("Invalid subscriptions - invalid qos")), !1;
            if (n === 5) {
                if (typeof (a[m].nl || !1) != "boolean") return e.destroy(new Error("Invalid subscriptions - invalid No Local")), !1;
                if (typeof (a[m].rap || !1) != "boolean") return e.destroy(new Error("Invalid subscriptions - invalid Retain as Published")), !1;
                let w = a[m].rh || 0;
                if (typeof w != "number" || w > 2) return e.destroy(new Error("Invalid subscriptions - invalid Retain Handling")), !1;
            }
        ...
        for (let m of a){
            ...
            Br(e, g), _ = ue.SUBSCRIBE_OPTIONS_QOS[P], n === 5 && (_ |= S ? ue.SUBSCRIBE_OPTIONS_NL : 0, _ |= b ? ue.SUBSCRIBE_OPTIONS_RAP : 0, _ |= w ? ue.SUBSCRIBE_OPTIONS_RH[w] : 0), d = e.write(se.from([
                _
            ]));
        }
        return d;
    ...
    function dE(t, e, r) {
        ...
        if (f += 2, typeof a == "object" && a.length) for(let m = 0; m < a.length; m += 1){
            if (typeof a[m] != "string") return e.destroy(new Error("Invalid unsubscriptions")), !1;
    ...
    function pE(t, e, r) {
        ...
        if (n === 5) if (typeof a == "object" && a.length) for(let g = 0; g < a.length; g += 1){
            if (typeof a[g] != "number") return e.destroy(new Error("Invalid qos vector")), !1;
            d += 1;
        }
        else return e.destroy(new Error("Invalid qos vector")), !1;
        let m = null;
            ...
            case "pair":
                {
                    Object.getOwnPropertyNames(r).forEach((i)=>{
                        ...
                        Array.isArray(s) ? s.forEach((o)=>{
                            t.write(se.from([
                                ue.properties[e]
                            ])), Yp(t, i.toString(), o.toString());
                        }) : (t.write(se.from([
                            ue.properties[e]
                        ])), Yp(t, i.toString(), s.toString()));
                    });
                    break;
                }
            default:
...
var Sy = j((_o)=>{
    ...
    _o.LRUCache = void 0;
    var gn = typeof performance == "object" && performance && typeof performance.now == "function" ? performance : Date, my = new Set, $a = typeof N == "object" && N ? N : {}, _y = (t, e, r, n)=>{
...
var Pu = j((Fo, Jy)=>{
    ...
    I();
    (function(t, e) {
        typeof Fo == "object" && typeof Jy < "u" ? e(Fo) : typeof define == "function" && define.amd ? ((r)=>r !== undefined && __turbopack_context__.v(r))(e(exports)) : (t = typeof globalThis < "u" ? globalThis : t || self, e(t.fastUniqueNumbers = {}));
    })(Fo, function(t) {
        "use strict";
        var e = function(m) {
            return function(g) {
...
var _g = j((Ho, mg)=>{
    ...
    I();
    (function(t, e) {
        typeof Ho == "object" && typeof mg < "u" ? e(Ho, Pu(), tg(), ug(), cg(), wg()) : typeof define == "function" && define.amd ? ((r)=>r !== undefined && __turbopack_context__.v(r))(e(exports, __turbopack_context__.r("[project]/node_modules/fast-unique-numbers/build/es5/bundle.js [app-client] (ecmascript)"), __turbopack_context__.r("[project]/node_modules/@babel/runtime/helpers/defineProperty.js [app-client] (ecmascript)"), __turbopack_context__.r("[project]/node_modules/@babel/runtime/helpers/slicedToArray.js [app-client] (ecmascript)"), __turbopack_context__.r("[project]/node_modules/@babel/runtime/helpers/asyncToGenerator.js [app-client] (ecmascript)"), __turbopack_context__.r("[project]/node_modules/@babel/runtime/regenerator/index.js [app-client] (ecmascript)"))) : (t = typeof globalThis < "u" ? globalThis : t || self, e(t.brokerFactory = {}, t.fastUniqueNumbers, t._defineProperty, t._slicedToArray, t._asyncToGenerator, t._regeneratorRuntime));
                        ...
                        return i(s.mark(function y() {
                            ...
                            return s.wrap(function(U) {
                                for(;;)switch(U.prev = U.next){
                                    case 0:
                                        return O = new MessageChannel, v = O.port1, M = O.port2, U.next = 1, T("connect", {
                                            port: v
                                        }, [
                                            v
                                        ]);
...
var Sg = j((Vo, vg)=>{
    ...
    I();
    (function(t, e) {
        typeof Vo == "object" && typeof vg < "u" ? e(Vo, _g(), Pu(), Xn()) : typeof define == "function" && define.amd ? ((r)=>r !== undefined && __turbopack_context__.v(r))(e(exports, __turbopack_context__.r("[project]/node_modules/broker-factory/build/es2019/module.js [app-client] (ecmascript)"), __turbopack_context__.r("[project]/node_modules/fast-unique-numbers/build/es5/bundle.js [app-client] (ecmascript)"), __turbopack_context__.r("[project]/node_modules/@babel/runtime/helpers/typeof.js [app-client] (ecmascript)"))) : (t = typeof globalThis < "u" ? globalThis : t || self, e(t.workerTimersBroker = {}, t.brokerFactory, t.fastUniqueNumbers, t._typeof));
    })(Vo, function(t, e, r, n) {
        "use strict";
        var i = function(w) {
            return function(_) {
        ...
        ]), h = i(c), d = s(f), m = o(r.generateUniqueNumber, c), g = a(r.generateUniqueNumber, f), P = e.createBroker({
...
var Ag = j((Go, Eg)=>{
    ...
    I();
    (function(t, e) {
        typeof Go == "object" && typeof Eg < "u" ? e(Go, Sg()) : typeof define == "function" && define.amd ? ((r)=>r !== undefined && __turbopack_context__.v(r))(e(exports, __turbopack_context__.r("[project]/node_modules/worker-timers-broker/build/es2019/module.js [app-client] (ecmascript)"))) : (t = typeof globalThis < "u" ? globalThis : t || self, e(t.workerTimers = {}, t.workerTimersBroker));
    })(Go, function(t, e) {
        "use strict";
        var r = function(h, d) {
            var m = null;
...
var Gu, Lg, hr, w5, m5, _5, v5, S5, E5, Ug = ze(()=>{
    A();
    x();
    I();
    Gu = {}, Lg = !1;
...
function Wr() {
    ...
    var d = function() {
        ...
        "%MapIteratorPrototype%": typeof Map > "u" || !g || !S ? t : S(new Map()[Symbol.iterator]()),
        "%Math%": Math,
        "%Number%": Number,
        "%Object%": Object,
        ...
        "%SetIteratorPrototype%": typeof Set > "u" || !g || !S ? t : S(new Set()[Symbol.iterator]()),
...
function bl(t) {
    ...
    return t && (n = n - t[0], i = i - t[1], i < 0 && (n--, i += gl)), [
        n,
        i
    ];
}
...
function Px() {
    ...
    Al = function k(B, re, ie, oe) {
        ...
        if (typeof B == "object" && Qt) {
            if (X && typeof B[X] == "function" && te) return te(B, {
                depth: es - ie
            });
    ...
    var t = Ox(), e = Sb(), r = Bl(), n = Object.prototype.hasOwnProperty, i = {
        ...
        if (d(V) || e.isBuffer(V)) {
            if (M) {
                ...
                return [
                    z(Z) + "=" + z(M(V, h.encoder, ee, "value", H))
                ];
            }
            return [
                z(w) + "=" + z(String(V))
        ...
        var he;
        if (_ === "comma" && s(V)) J && M && (V = e.maybeMap(V, M)), he = [
            {
...
function kx() {
    ...
    var t = Sb(), e = Object.prototype.hasOwnProperty, r = Array.isArray, n = {
        ...
        for(T = 0; T < _.length; ++T)if (T !== R) {
            ...
            })), U && P.interpretNumericEntities && y === "iso-8859-1" && (U = i(U)), O.indexOf("[]=") > -1 && (U = r(U) ? [
                U
            ] : U);
            var Q = e.call(S, F);
        ...
        for(var b = S ? g : s(g, P), w = m.length - 1; w >= 0; --w){
            ...
            if (R === "[]" && P.parseArrays) _ = P.allowEmptyArrays && (b === "" || P.strictNullHandling && b === null) ? [] : [].concat(b);
                ...
                !P.parseArrays && y === "" ? _ = {
                    0: b
                } : !isNaN(O) && R !== y && String(O) === y && O >= 0 && P.parseArrays && O <= P.arrayLimit ? (_ = [], _[O] = b) : y !== "__proto__" && (_[y] = b);
            }
            b = _;
        }
        return b;
        ...
        var b = typeof g.allowDots > "u" ? g.decodeDotInKeys === !0 ? !0 : n.allowDots : !!g.allowDots;
        return {
            allowDots: b,
...
var Tx, Al, pb, Il, xl, yb, Tl, gb, Pl, bb, Ol, wb, Rl, mb, kl, _b, Hr, vb, Ge, Mx, Nx, qx, Lx, Ux, Dx, jx, Fx, Wx, $x, Hx, Cl, Vx, Gx, zx, Kx, Qx, Yx, xb = ze(()=>{
    ...
    db();
    vl();
    Tx = Object.freeze(Object.create(null)), Al = {}, pb = !1, Il = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : /*TURBOPACK member replacement*/ __turbopack_context__.g;
    xl = {}, yb = !1;
    Tl = {}, gb = !1;
    Pl = {}, bb = !1;
    Ol = {}, wb = !1;
...
var Qo = j((mi)=>{
    ...
    var Ml = class extends Zx.Duplex {
        ...
        constructor(e, r, n){
            super({
                objectMode: !0
            }), this.proxy = r, this.socket = n, this.writeQueue = [], e.objectMode || (this._writev = Rb.bind(this)), this.isSocketOpen = !1, this.proxy.on("data", (i)=>{
...
//# sourceMappingURL=node_modules_mqtt_dist_mqtt_esm_0fqkhf-.js.map